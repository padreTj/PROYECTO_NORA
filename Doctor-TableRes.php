...
// Create connection
$obj_conexion = new mysqli($servername, $username, $password, $dbname);
// Check connection
    ...
    <div class="container-formularios">
        <div class="formulario343">
            ...
            <table border="1" class="tablaUS2">
                            ...
                            $sql234=mysqli_query($obj_conexion,"SELECT Preguntas.idPregunta,datosPersonales.nombre,pregunta,respuesta FROM Preguntas JOIN ".$nomm."_Preguntas ON ".$nomm."_Preguntas.idPregunta=Preguntas.idPregunta JOIN datosPersonales ON datosPersonales.idUsuario=".$nomm."_Preguntas.idUsuario");
