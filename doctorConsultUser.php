...
?></h1>
    ...
    <div class="container-formularios">
        <div class="formulario">
            <center><br>
               <form name="consultaUsuario" action="Doctor-TableUser.php" method="POST">
                            <center>
                                <h2>Consulta un paciente.</h2>
                                <div class="tablaFlow">
                                <table border="1">
                                    <thead>
                                        <tr>
...
?>
                         ...
                         <b>Escribe el nombre del paciente</b><br>
                            <input type="text" name="term" id="term" placeholder="Nombre Usuario"><br><br>
